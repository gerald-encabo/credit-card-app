    ...
    <div className="services">
      <div className="services__wrapper">
         ...
         <div className="services__container">
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-1.svg" className="services__container-img" alt="Managed Services display image"/>
              ...
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-2.svg" className="services__container-img" alt="Financial Services display image"/>
              ...
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-3.svg" className="services__container-img" alt="Cardholder Services display image"/>
         ...
         <div className="services__container">
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-4.svg" className="services__container-img" alt="Authentication Services display image"/>
              ...
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-5.svg" className="services__container-img" alt="Financial Services display image"/>
              ...
              <Link to="/" className="services__container-card">
                    <div className="services__container-cardInfo">
                        <img src="/images/svg-services-6.svg" className="services__container-img" alt="Cardholder Services display image"/>
